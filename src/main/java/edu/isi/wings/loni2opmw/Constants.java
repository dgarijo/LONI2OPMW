...
public class Constants {
    ...
    *****/
    ...
    public static final String DATA_PROP_CREATOR = "http://purl.org/dc/elements/1.1/creator";
...
//    public static final String WINGS_PROP_HAS_EXECUTION_DIAGRAM = WFLOW + "hasExecutionDiagram"; 
    ...
    *****/
    ...
    public static final String P_PLAN_PROP_IS_PRECEDED_BY =  PREFIX_P_PLAN+ "isPrecededBy";
